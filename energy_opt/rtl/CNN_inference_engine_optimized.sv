`timescale 1ns / 1ps
/* ============================================================
   CNN_Inference_Engine - ENERGY-OPTIMIZED Top-Level
   
   Uses optimized sub-modules:
   - KPU: kpu_optimized.sv (OPT-1 through OPT-5)
   - IEC: IEC_optimized.sv (OPT-6 through OPT-9)
   - CU:  CU_optimized.sv  (OPT-10 through OPT-12)
   ============================================================ */
